...
let all = document.getElementsByClassName('dom-methods');
...
let allFont = document.querySelectorAll('.dom-methods');
for (i = 0; i < allFont.length; i++) {
  allFont[i].style.fontSize = '20px';
}
...
let idValue = newDiv.getAttribute('id');
console.log(idValue);
...
copyrightDiv.removeAttribute('class');
